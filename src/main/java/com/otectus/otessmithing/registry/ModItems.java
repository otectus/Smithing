...
import com.otectus.otessmithing.item.HotWorkpieceItem;
import com.otectus.otessmithing.item.SmithingGuideItem;
import com.otectus.otessmithing.item.SmithingHammerItem;
import com.otectus.otessmithing.item.SmithingTier;
import com.otectus.otessmithing.item.SmithingTongsItem;
import com.otectus.otessmithing.item.StationBlockItem;
...
public final class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, OtesSmithing.MOD_ID);
