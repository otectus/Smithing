...
public final class WorkpieceCodec {
    ...
    public static Optional<WorkpieceData> load(CompoundTag tag) {
        try {
            ...
            if (recipe == null) recipe = OtesSmithing.id("unknown");
            if (family == null) family = OtesSmithing.id("unknown");
            ...
            OtesSmithing.LOGGER.warn("Discarding unreadable workpiece data: {}", e.toString());
