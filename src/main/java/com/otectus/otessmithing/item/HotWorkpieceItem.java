...
public class HotWorkpieceItem extends Item {
    ...
    public Component getName(ItemStack stack) {
        return WorkpieceCodec.getHeld(stack)
                .<Component>map(d -> Component.translatable("item.otes_smithing.hot_workpiece.of", d.target().getHoverName()))
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("tooltip.otes_smithing.hot_workpiece").withStyle(ChatFormatting.GRAY));
    }
