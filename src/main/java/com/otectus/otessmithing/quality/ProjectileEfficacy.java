...
import com.otectus.otessmithing.compat.spartanweaponry.SpartanCompat;
...
public final class ProjectileEfficacy {
    private static final String SCALED = OtesSmithing.MOD_ID + ":efficacy_scaled";
    ...
    public static double efficacy(ItemStack stack) {
        ...
        if (data.isEmpty() || OtesSmithingAPI.isExcluded(stack)) return 1.0;
