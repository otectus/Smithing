...
public final class MaterialUnits {
    ...
    public static Component describe(int units) {
        ...
        if (ingots > 0 && nuggets > 0) {
            return Component.translatable("units.immersive_smithing.ingots_nuggets", ingots, nuggets);
        }
        if (ingots > 0) {
            return Component.translatable(ingots == 1 ? "units.immersive_smithing.ingot" : "units.immersive_smithing.ingots", ingots);
        }
        return Component.translatable(nuggets == 1 ? "units.immersive_smithing.nugget" : "units.immersive_smithing.nuggets", nuggets);
    }
