...
import com.otectus.immersivesmithing.minigame.ForgeSession;
...
import com.otectus.immersivesmithing.minigame.SessionTiming;
...
public final class StationGameTests {
    ...
    public static void forgeSessionEscrowAndScoring(GameTestHelper h) {
        ...
        SessionManager.selectRecipe(player, session.id, ImmersiveSmithing.id("invented"));
    ...
    public static void minigameRulesAndTiming(GameTestHelper h) {
        ...
        AnvilPattern anvil = AnvilPattern.fallback(ImmersiveSmithing.id("x"));
