...
**Immersive Smithing** is a Forge 1.20.1 mod that replaces the ordinary crafting-table creation of metal equipment with a short, physical, skill-based smithing process.
...
- no vanilla Smithing Table upgrade process required by Immersive Smithing recipes
...
1. explicit Immersive Smithing recipe/material definition
...
- an item explicitly included in `immersive_smithing:smithable_equipment`

Use multiple signals:

- vanilla item class inheritance where available
- Forge/common equipment tags
- Immersive Smithing inclusion tags
- recipe structure
...
Immersive Smithing does not manufacture bronze from copper and tin in 1.0.
...
```text
data/<namespace>/immersive_smithing/recipes/<name>.json
```
...
The player must use Immersive Smithing.
...
- Immersive Smithing remains available as an alternative
...
Do not assume every instance of a smithable item must originate from Immersive Smithing.
...
Keep explicit records of recipes hidden or disabled by Immersive Smithing for:
...
If Immersive Smithing cannot safely modify a particular item's efficacy:
...
Smith villagers may occasionally sell the Immersive Smithing guide book or related supplies.
...
Create an Immersive Smithing recipe category.
...
If Immersive Smithing disables an original crafting recipe, JEI should not misleadingly present the disabled crafting-table recipe.
...
```text
immersive_smithing:smithable_shields
immersive_smithing:non_smithable_shields
```
...
Because vanilla Netherite equipment normally upgrades Diamond equipment, Immersive Smithing must deliberately define its own path.
...
```text
/immersivesmithing reload
/immersivesmithing material <item>
/immersivesmithing recipe <item>
/immersivesmithing quality <held item>
/immersivesmithing report
/immersivesmithing session
```
...
immersive_smithing:non_smithable_equipment
immersive_smithing:smithable_shields
immersive_smithing:non_smithable_shields
immersive_smithing:forge_fuels
immersive_smithing:forge_igniters
immersive_smithing:netherite_fuels
immersive_smithing:hammers
immersive_smithing:tongs
```
...
That loop should be the identity of **Immersive Smithing**.
